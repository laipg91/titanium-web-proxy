            ...
            X509Certificate2? signingCertificate)
        {
            ...
            if (signingCertificate != null)
            {
                ...
                if (IPAddress.TryParse(subject, out ip))
                {
                    ...
                    typeCAlternativeName.InvokeMember("InitializeFromRawData", BindingFlags.InvokeMethod, null,
                        altDnsNames,
                        typeValue);
                }
                else
                {
                    ...
                    typeCAlternativeName.InvokeMember("InitializeFromString", BindingFlags.InvokeMethod, null,
                        altDnsNames,
                        typeValue);
                }
